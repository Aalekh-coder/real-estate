    ...
    <footer className="bg-white text-black py-8">
      <div className="container mx-auto px-4 grid grid-cols-1 md:grid-cols-4 gap-8">
        ...
        <div className="flex flex-col items-start">
          ...
          <p className="text-sm">
            Your trusted partner in finding your perfect property. Simplifying
            real estate, one home at a time.
          </p>
        </div>
        ...
        <div>
          ...
          <ul className="text-sm space-y-2">
            ...
            <li className="flex items-center">
              <MapPin size={16} className="mr-2" /> C3 B/243, Janakpuri, New Delhi,
              India 110058
            </li>
          </ul>
        </div>
      ...
      <div className="border-t border-gray-200 mt-8 pt-4 text-center text-sm text-gray-600">
        ...
        <a
          target="_blank"
          href="https://www.softmoreit.co.in"
          className="hover:underline text-yellow-400"
        >
          Softmore IT Solutions.
        </a>{" "}
        All rights reserved. | <a className="hover:underline">Privacy Policy</a>
      </div>
    </footer>
  );
};
