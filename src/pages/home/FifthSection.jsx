  ...
  return (
    <div className="flex items-center justify-between flex-col md:flex-row text-[#1A1A1A] md:px-10">
      <div className="relative px-5 py-5 md:w-1/2 mt-10">
        <img src="/fifth/pexels-maksim-romashkin-19127450.jpg" className="h-[50vh] rounded-xl lg:h-[60vh] " />
        <img src="/fifth/pexels-mart-production-7415062.jpg" className="h-[50vh] rounded-xl absolute left-28 top-24 border-white lg:h-[60vh] lg:left-[40vh]"/>
        <img src="/fifth/pexels-mart-production-7415122.jpg" className="rounded-xl mt-10 lg:w-[35vw]"/>
      </div>
